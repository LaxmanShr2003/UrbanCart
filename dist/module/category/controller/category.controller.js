...
exports.categoryController = {
    createCategory: function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
        var categoryData, response, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    categoryData = req.body;
                    return [4, category_service_1.categoryService.create(categoryData)];
                case 1:
                    response = _a.sent();
                    res
                        .status(200)
                        .json((0, messageFormater_1.formatMessage)(true, response, "Category data saved successfully"));
                    return [3, 3];
                case 2:
                    error_1 = _a.sent();
                    next(error_1);
    ...
    findAll: function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4, category_service_1.categoryService.findAll()];
                case 1:
                    response = _a.sent();
                    res
                        .status(200)
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    categoryId = req.params.id;
                    return [4, category_service_1.categoryService.removeCategory(categoryId)];
                case 1:
                    response = _a.sent();
                    res
                        .status(200)
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4, category_service_1.categoryService.updateCategory(categoryId, categroyData)];
                case 1:
                    response = _a.sent();
                    res
                        .status(200)
