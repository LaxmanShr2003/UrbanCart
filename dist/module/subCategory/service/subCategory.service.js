...
var subCategory_repository_1 = require("../repository/subCategory.repository");
exports.subCategoryService = {
    create: function (data) { return __awaiter(void 0, void 0, void 0, function () {
        var runner, categoryId, isCategoryExists, subCategoryName, isNameExists, response, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    return [4, category_service_1.categoryService.getById(categoryId)];
                case 3:
                    ...
                    return [4, subCategory_repository_1.subCategoryRepository.findByName({
                            runner: runner,
                ...
                case 4:
                    ...
                    console.log(data.categoryId, "sivjdoifvjs");
                    return [4, subCategory_repository_1.subCategoryRepository.create({ runner: runner, data: data })];
                case 5:
                    response = _a.sent();
                    if (!response)
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    return [4, subCategory_repository_1.subCategoryRepository.findById({ runner: runner, id: id })];
                case 3:
                    response = _a.sent();
                    if (!response)
                        throw new ExceptionHandler_1.default("Category not found", 404);
    ...
    findAll: function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    _a.trys.push([2, 4, 5, 6]);
                    return [4, subCategory_repository_1.subCategoryRepository.find({ runner: runner })];
                case 3:
                    response = _a.sent();
                    if (!response)
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    ...
                    return [4, subCategory_repository_1.subCategoryRepository.remove({ runner: runner, id: id })];
                case 4:
                    response = _a.sent();
    ...
    updateCategory: function (id, data) { return __awaiter(void 0, void 0, void 0, function () {
        var runner, subCategoryName, isIdExists, response, error_5;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4, ORMHelper_1.default.createQueryRunner()];
                case 1:
                ...
                case 3:
                    ...
                    if (subCategoryName == isIdExists.subCategoryName)
                        throw new Error("Category name already exists or cannot be dublicate");
                    return [4, subCategory_repository_1.subCategoryRepository.update({ runner: runner, data: data, id: id })];
                case 4:
                    response = _a.sent();
                    if (!response)
